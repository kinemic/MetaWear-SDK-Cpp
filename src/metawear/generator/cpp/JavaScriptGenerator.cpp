...
static const unordered_map<string, string> SHORTENED_PREFIXES = {
...
static string createPrefix(const string& in) { 
    string prefix;
    bool first = true;
...
void JavaScriptGenerator::create(ostream& os, const CHeaderFile& header) {
    ...
    os << "FnVoid_MetaWearBoardP_AnonymousDataSignalP_UInt = ffi.Function(ref.types.void, [ref.refType(MetaWearBoard), ArrayAnonymousDataSignalP, ref.types.uint32]);" << endl;    
